...
export const SHELVES: { id: Shelf; name: string; note: string }[] = [
  ...
  },
  {
    ...
    note: "A moving layer over the whole card.",
  },
...
export const SHOP: ShopItem[] = [
  ...
  /* profile effects */
  {
    ...
    shelf: "effect",
    name: "Doves",
    desc: "Doves in flight across your card.",
    price: 980,
    was: 1180,
  },
  {
    ...
    shelf: "effect",
    name: "Glitch",
    desc: "Your card, thoroughly datamoshed.",
    price: 1120,
    was: 1340,
  },
  {
    ...
    shelf: "effect",
    name: "Duck Pond",
    desc: "Lily pads above, sunbeams below.",
    price: 1260,
    was: 1480,
  },
  {
    ...
    shelf: "effect",
    name: "Rainfall",
    desc: "Fine rain over everything.",
    price: 880,
    was: 1040,
  },
  {
    ...
    shelf: "effect",
    name: "Embers",
    desc: "Slow orange sparks rising off the card.",
    price: 1060,
    was: 1260,
  },
  {
    ...
    shelf: "effect",
    name: "Aurora",
    desc: "Bands of light drifting behind the card.",
    price: 1420,
    was: 1660,
  },
