...
export const SHOP: ShopItem[] = [
  ...
  /* profile effects: whole-card backgrounds, looping and silent */
  {
    ...
    shelf: "effect",
    name: "Rainy Window",
    desc: "A pixel night: rain, a roof, a cat that will not come in.",
    price: 1180,
    was: 1400,
  },
  {
    ...
    shelf: "effect",
    name: "Voxel Valley",
    desc: "Block terrain, one cloud going by, an endless afternoon.",
    price: 1320,
    was: 1560,
  },
  {
    ...
    shelf: "effect",
    name: "Honeycomb",
    desc: "Hexagons along a dark wall, lighting up in turn.",
    price: 1080,
    was: 1280,
  },
  {
