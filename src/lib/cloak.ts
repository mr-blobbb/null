...
export const CLOAKS: Cloak[] = [
  ...
  { id: "blooket", name: "Blooket", title: "Blooket", icon: tile("#3b4b8f", "B") },
  { id: "edpuzzle", name: "Edpuzzle", title: "Edpuzzle", icon: tile("#ff6b35", "E") },
  { id: "kahoot", name: "Kahoot!", title: "Kahoot!", icon: tile("#46178f", "K") },
